...
const projects = [
  {
    ...
    image: "/assets/projects/inclinic.png",
    // source_code_link: "https://github.com/Shivam-Sharma-1/FigPro",
    deployed_link: "https://app.inclinic.vc",
  },
  {
    name: "Inshop",
  ...
  },
  {
    name: "Netflix Clone",
    description:
      "Netflix-Clone is a fully responsive web application that replicates the popular streaming platform Netflix. It is built using Next.js, Prisma, React, NextAuth.js, Tailwind CSS, and TypeScript. This project aims to showcase the implementation of these technologies to create a feature-rich clone of Netflix.",
    tags: [
      {
        name: "next.js",
        color: "blue-text-gradient",
...
const socials = [
  {
    id: "github",
    icon: <GithubIcon />,
    link: "https://github.com/vijayaraj08",
  },
  {
    id: "linkedin",
    icon: <LinkedInIcon />,
    link: "https://www.linkedin.com/in/vijaya-raj",
  },
  // {
  //   id: "x",
  //   icon: <XIcon />,
  ...
  // },
  {
    id: "instagram",
    icon: <InstagramIcon />,
    link: "https://www.instagram.com/life.of_vxt",
  },
];
