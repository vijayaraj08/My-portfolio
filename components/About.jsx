...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
          Hello! I&apos;m Vijayaraj, a passionate web developer and problem
          solver. Currently, I&apos;m the fullstack Developeer in an company, and
          I&apos;m pursuing a B.Tech. degree in Artificial Intelligence and Data Science at
          SRM valliammai College Of Engineering in chengalpattu, India, with an expected
          graduation year of 2024. I&apos;m a software developer with experience
          in Node.js, TailwindCSS, and JavaScript. I specialize in frameworks
          such as React, Node.js, python. My knowledge extends to fundamental data structures and algorithms,
        ...
        <div className="w-fit break-words">
          <Link
            href="mailto:vijayarajunnikrishnan@gmail.com"
            target="_blank"
            rel="noreferrer"
          ...
          >
            ...
            vijayarajunnikrishnan@gmail.com
          </Link>
        </div>
