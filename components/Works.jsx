    ...
    <section className="xl:my-36 md:mx-36 p-8 " id="projects">
      ...
      <div className="w-full flex">
        <motion.p
          ...
          viewport={{ once: true, amount: 0.25 }}
        >
          These projects showcase my practical skills and experience across a diverse range of domains. They demonstrate my ability to handle complex challenges, adapt to different technologies, and oversee projects from start to finish.Through these projects, I have developed a strong foundation in key areas such as problem-solving, critical thinking, and project management. I have worked with various technologies and tools, including programming languages, frameworks, databases, and cloud platforms, allowing me to deliver high-quality solutions across different industries.
        </motion.p>
      </div>
